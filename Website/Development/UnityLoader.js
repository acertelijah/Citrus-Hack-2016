...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Bye-Nary HTML5.data';
    var REMOTE_PACKAGE_BASE = 'Bye-Nary HTML5.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6673217;
      var PACKAGE_UUID = '16ebb8f9-69fe-42be-923e-5928a528a089';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 3896563, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(3896563, 3896703, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(3896703, 3899700, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(3899700, 5770620, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(5770620, 6645592, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(6645592, 6673217, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Bye-Nary HTML5.data');

    };
    Module['addRunDependency']('datafile_Bye-Nary HTML5.data');
